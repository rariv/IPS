...
namespace UPM_IPS.DRMRRBRRMProyectoIPS
{
	...
	/// </remarks>
	public partial class DRMRRBRRMProyectoIPSHelpKeywordHelper : DRMRRBRRMProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DRMRRBRRMProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected DRMRRBRRMProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DRMRRBRRMProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static DRMRRBRRMProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DRMRRBRRMProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DRMRRBRRMProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected DRMRRBRRMProyectoIPSHelpKeywordHelperBase()
			: base() { }
