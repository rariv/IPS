...
namespace UPM_IPS.DRMRRBRRMProyectoIPS
{
	...
	/// </summary>
	internal partial class DRMRRBRRMProyectoIPSCommandSet : DRMRRBRRMProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new DRMRRBRRMProyectoIPSCommandSet.
		/// </summary>
		public DRMRRBRRMProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DRMRRBRRMProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DRMRRBRRMProyectoIPSCommandSetBase.
		/// </summary>
		protected DRMRRBRRMProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDRMRRBRRMProyectoIPSExplorerCommand,
				typeof(DRMRRBRRMProyectoIPSEditorFactory).GUID);
		...
		{
			DRMRRBRRMProyectoIPSExplorerToolWindow explorer = this.DRMRRBRRMProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DRMRRBRRMProyectoIPSDocData CurrentDRMRRBRRMProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DRMRRBRRMProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DRMRRBRRMProyectoIPSDocView CurrentDRMRRBRRMProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DRMRRBRRMProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected DRMRRBRRMProyectoIPSExplorerToolWindow DRMRRBRRMProyectoIPSExplorerToolWindow
		{
			get
			{
				DRMRRBRRMProyectoIPSExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DRMRRBRRMProyectoIPSExplorerToolWindow), true) as DRMRRBRRMProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DRMRRBRRMProyectoIPSExplorerToolWindow explorerWindow = this.DRMRRBRRMProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DRMRRBRRMProyectoIPSClipboardCommandSet : DRMRRBRRMProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DRMRRBRRMProyectoIPSClipboardCommandSet.
		/// </summary>
		public DRMRRBRRMProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DRMRRBRRMProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DRMRRBRRMProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected DRMRRBRRMProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
